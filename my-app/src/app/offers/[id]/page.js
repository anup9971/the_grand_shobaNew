            ...
            <Link href="/offers" >
             ...
             <div className='p-5'>
                <h2 className='text-2xl md:text-4xl text-black'>18% Off on the 18th of Every Month</h2>
                 <p className='text-gray-600 pt-4 font-light'>Mark your calendar—every 18th is Members’ Day, an exclusive opportunity for World of Hyatt members to save 18% on stays at participating Hyatt hotels across India and Nepal. This limited-time offer is available for one day only: simply book on the 18th using offer code SPECIAL18 to secure this rate on all room types. With stays completed within 30 days of booking, this monthly offer is crafted exclusively for you—seize the moment to elevate your next stay.</p>
                <p className='text-gray-600 pt-4 font-light'>Not a World of Hyatt member? Sign up now. Membership is free.</p>
                       ...
                       <div>
                         {
                            condition &&(
                                <>
                                <p className='text-gray-700 font-light pt-5 bg-[#ffffff6b]  p-2 md:p-4 rounded-xl'>Mark your calendar—every 18th is Members’ Day, an exclusive opportunity for World of Hyatt members to save 18% on stays at participating Hyatt hotels across India and Nepal. This limited-time offer is available for one day only: simply book on the 18th using offer code SPECIAL18 to secure this rate on all room types. With stays completed within 30 days of booking, this monthly offer is crafted exclusively for you—seize the moment to elevate your next stay.</p>
                                <p className='text-gray-700 font-light pt-5 mt-3 bg-[#ffffff6b]  p-2 md:p-4 rounded-xl'>Mark your calendar—every 18th is Members’ Day, an exclusive opportunity for World of Hyatt members to save 18% on stays at participating Hyatt hotels across India and Nepal. This limited-time offer is available for one day only: simply book on the 18th using offer code SPECIAL18 to secure this rate on all room types. With stays completed within 30 days of booking, this monthly offer is crafted exclusively for you—seize the moment to elevate your next stay.</p>
                                <p className='text-gray-700 font-light pt-5 mt-3 bg-[#ffffff6b]  p-2 md:p-4 rounded-xl'>Mark your calendar—every 18th is Members’ Day, an exclusive opportunity for World of Hyatt members to save 18% on stays at participating Hyatt hotels across India and Nepal. This limited-time offer is available for one day only: simply book on the 18th using offer code SPECIAL18 to secure this rate on all room types. With stays completed within 30 days of booking, this monthly offer is crafted exclusively for you—seize the moment to elevate your next stay.</p>
                                </>
                            )
                         }
